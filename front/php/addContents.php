<?php
    ...
    /********** Validacion de datos ****************/
	if(!isset($_POST["author"]) || !isset($_POST["category"]) || !isset($_POST["title"]) || !isset($_POST["contenido"]) )
	{
	...
	$url	=	'https://acadserv.upaep.mx/proyecto_final/equipo2/api/service/contents/';
	$post	=	$_POST;
	$metodo	=	"POST";
